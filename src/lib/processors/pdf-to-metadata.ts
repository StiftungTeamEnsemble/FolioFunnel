...
export async function pdfToMetadata(ctx: ProcessorContext): Promise<ProcessorResult> {
  ...
  try {
    ...
    const response = await fetch(`${DOCUMENT_CONVERTER_API_URL}/extract-metadata`, {
      method: 'POST',
      headers: {
